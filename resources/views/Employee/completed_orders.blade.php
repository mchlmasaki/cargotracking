                    ...
                    <div class="col-md-12">
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                          ...
                          <li role="presentation" class="active"><a href="{{  url('Employee/completed_orders') }}"  aria-expanded="false">Completed</a>
                          </li>
                  ...
                  <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                      ...
                      @foreach($shipments as $shipment)
                        ...
                        <td>{{ $shipment->id }}</td>
                          ...
                          <td><a href="{{ url('Client/shipmentdetails/'.$shipment->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-folder"></i> View </a><button data-toggle="modal" href="#modalDefault" onclick="return editUser('{{ $shipment->id }}','{{ $shipment->cons_no }}','{{ $shipment->from_location }}','{{ $shipment->to_location }}','{{ $shipment->status }}')" class="btn btn-success btn-sm "><i class="fa fa-edit"></i> Update </button> 
                          <a class="btn btn-danger btn-sm waves-effect waves-light remove-record" onclick="return confirmDelete('{{ $shipment->id }}')" data-toggle="modal" data-url="{!! URL::to('Employee/completed_orders/delete', $shipment->id) !!}" data-id="{{$shipment->id}}" data-target="#confirmDelete"><i class="fa fa-trash"></i>&nbsp;Delete</a>
                          </td>
...
<form action="{{ URL::to('Employee/completed_orders/delete/') }}" method="POST" class="remove-record-model">
{{csrf_field()}}
{{method_field('delete')}}
                  ...
                  <div class="modal fade" id="modalDefault" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- New Task form-->
                          <form name="user_form" action="{{ URL::to('Employee/completed_orders')}}" method="POST" class="form-horizontal">
                          {!! csrf_field() !!}
...
<script type="text/javascript">
  function editUser(id,cons_no,from_location,to_location,status)
  {
