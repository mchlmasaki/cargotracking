            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <button data-toggle="modal" href="#addClientModal" class="btn btn-success btn-sm "><i class="fa fa-plus"></i> Add Clients </button>
                      ...
                      @foreach($users as $user)
                        ...
                        <td>{{ $user->id }}</td>
                          ...
                          <td>
                            ...
                            ?></td>
                          <td><button data-toggle="modal" href="#updateClientModal" onclick="return editUser('{{ $user->id }}','{{ $user->name }}','{{ $user->email }}','{{ $user->contact }}')" class="btn btn-success btn-sm "><i class="fa fa-edit"></i> Update </button> 
                          <a class="btn btn-danger btn-sm waves-effect waves-light remove-record" onclick="return confirmDelete('{{ $user->id }}')" data-toggle="modal" data-url="{!! URL::to('Employee/users/delete', $user->id) !!}" data-id="{{$user->id}}" data-target="#confirmDelete"><i class="fa fa-trash"></i>&nbsp;Delete</a></td>
                          </td>
                        </tr>
                         @endforeach
                      </tbody>
...
<form action="{{ URL::to('Employee/users/delete/') }}" method="POST" class="remove-record-model">
{{csrf_field()}}
{{method_field('delete')}}
              ...
              <!-- Small modal -->
                  ...
                  <div class="modal fade" id="addClientModal" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title"><center>Add Clients</center> </h4>
                                        </div>

                                        <div class="modal-body">
                                            <!-- New Task form-->
                          <form name="user_form" action="{{ URL::to('Employee/users')}}" method="POST" class="form-horizontal">
                          {!! csrf_field() !!}
                          <?php 
                  ...
                  <div class="modal fade" id="updateClientModal" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- New Task form-->
                          <form name="user_form" action="{{ URL::to('Employee/users/update')}}" method="POST" class="form-horizontal">
                          {!! csrf_field() !!}
