                      ...
                      @foreach($users as $user)
                        ...
                        <td>{{ $user->id }}</td>
                          ...
                          <td>
                            ...
                            ?></td>
                          <td><button data-toggle="modal" href="#updateAdmin" onclick="return editUser('{{ $user->id }}','{{ $user->name }}','{{ $user->contact }}','{{ $user->email }}','{{ $user->role }}')" class="btn btn-success btn-xs "><i class="fa fa-edit"></i> Update </button>
                          <a class="btn btn-danger btn-xs waves-effect waves-light remove-record" onclick="return confirmDelete('{{ $user->id }}')" data-toggle="modal" data-url="{!! URL::to('Admin/admins/delete', $user->id) !!}" data-id="{{$user->id}}" data-target="#confirmDelete"><i class="fa fa-trash"></i>&nbsp;Delete</a>
                          </td>
                        </tr>
                         @endforeach
                      </tbody>
...
{{method_field('delete')}}
 ...
 <!-- /Delete Confirm modals -->
              ...
              <!-- Update modal -->
                  ...
                  <div class="modal fade" id="updateAdmin" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
