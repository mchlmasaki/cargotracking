...
<div class="form-group">
	<label for="task" class="col-sm-3 control-label">Container Name</label>
	<div class="col-sm-6">
...
<div class="form-group">
	<label for="task" class="col-sm-3 control-label">Conatiner Number</label>
	<div class="col-sm-6">
...
<div class="form-group">
	...
	<table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
      ...
      <td>{{ $container->max_weight }}</td> <td>{{ $container->status }}</td>
			<td><button onclick="return editContainer('{{ $container->id }}','{{ $container->name }}','{{ $container->container_number }}','{{ $container->max_weight }}')" class="btn btn-success btn-xs "><i class="fa fa-edit"></i> edit </button> 
      <button data-toggle="modal" href="#updateStatus" onclick="return updateStatus('{{ $container->id }}','{{ $container->name }}','{{ $container->container_number }}','{{ $container->status }}')" class="btn btn-success btn-xs "><i class="fa fa-edit"></i> Update </button>
			<a class="btn btn-danger btn-xs waves-effect waves-light remove-record" onclick="return confirmDelete('{{ $container->id }}')" data-toggle="modal" data-url="{!! URL::to('Admin/containers/delete', $container->id) !!}" data-id="{{$container->id}}" data-target="#confirmDelete"><i class="fa fa-trash"></i>&nbsp;Delete</a>
            </td>
                        </tr>
                         @endforeach
                      </tbody>
