                  ...
                  <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                      <thead>
                        <tr>
                          ...
                          <th>Role</th> <th>Accont Status</th> <th>Action</th>
                        </tr>
                      </thead>
                      ...
                      @foreach($users as $user)
                        ...
                        <td>{{ $user->id }}</td>
                          ...
                          <td>
                            ...
                            ?></td>
                          <td>
                          <button data-toggle="modal" href="#modalDefault" onclick="return editUser('{{ $user->id }}','{{ $user->name }}','{{ $user->email }}','{{ $user->contact }}')" class="btn btn-success btn-xs "><i class="fa fa-edits"></i> Update </button>

                          <a class="btn btn-danger btn-xs waves-effect waves-light remove-record" onclick="return confirmDelete('{{ $user->id }}')" data-toggle="modal" data-url="{!! URL::to('Admin/users/delete', $user->id) !!}" data-id="{{$user->id}}" data-target="#confirmDelete"><i class="fa fa-trash"></i>&nbsp;Delete</a>
                          </td>
                        </tr>
                         @endforeach
                      </tbody>
