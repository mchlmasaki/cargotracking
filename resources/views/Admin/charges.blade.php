              ...
              <!-- Small modal -->
                  ...
                  <div class="modal fade" id="modalDefault" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- New Task form-->
                          <form name="user_form" action="{{ URL::to('Admin/charges')}}" method="POST" class="form-horizontal">
                          {!! csrf_field() !!}
                    ...
                    <div class="form-group{{ $errors->has('weight_from') ? ' has-error' : '' }}">
                        ...
                        @if ($errors->has('weight_from'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('weight_from') }}</strong>
                                    </span>
                        @endif
                    </div>
                </div>
                <div class='col-sm-3'>
                    ...
                    <div class="form-group{{ $errors->has('weight_to') ? ' has-error' : '' }}">
                        <div class='input-group date' >
                            <input type='text' class="form-control" id="weight_from" name="weight_to" value="{{ old('weight_to') }}" placeholder="20" />
                        </div>
                        @if ($errors->has('weight_to'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('weight_to') }}</strong>
                                    </span>
                        @endif
                    </div>
                </div>
