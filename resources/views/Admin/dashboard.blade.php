...
@include('flash::message')
          ...
          <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-group"></i> Total Drivers</span>
              <div class="count">2500</div>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-automobile"></i> Total Cars</span>
              <div class="count">{{ $total_containers }}</div>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-clock-o"></i> Requests</span>
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-cloud-upload"></i> Pending Orders</span>
              ...
              <div class="x_panel tile fixed_height_320">
                ...
                <div class="x_content">
                  ...
                  <div class="widget_summary">
                    ...
                    <div class="w_center w_55">
                      <div class="progress">
                        <div class="progress-bar bg-aero" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 25%;">
                          <span class="sr-only">60% Complete</span>
                        </div>
                      </div>
                    </div>
              ...
              <div class="x_panel tile fixed_height_320">
                ...
                <div class="x_content">
                  <div class="dashboard-widget-content">
                    <ul class="quick-list">
                      <li><i class="fa fa-calendar-o"></i><a href="#">Manage Users</a>
                      </li>
                      <li><i class="fa fa-bars"></i><a href="#">Bookings</a>
                      </li>
                      <li><i class="fa fa-bar-chart"></i><a href="#">Shipping Rates</a> </li>
                      <li><i class="fa fa-line-chart"></i><a href="#">Manage Shipments</a>
                      </li>
                      <li><i class="fa fa-bar-chart"></i><a href="#">Manage Braches</a> </li>
