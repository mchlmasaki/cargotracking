                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left input_mask" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" readonly value="{{ Auth::user()->role }}">
                        </div>
                      </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- New Task form--> 
                          <form name="edit_profile" action="{{ URL::to('Admin/edit_profile')}}" method="POST" class="form-horizontal">
                          {!! csrf_field() !!}
