                    ...
                    <div class="col-md-12">
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                          <li role="presentation" class="active"><a href="{{  url('Admin/all_orders') }}"  aria-expanded="true">All</a></li>
                          <li role="presentation" ><a href="{{  url('Admin/pending_orders') }}"  aria-expanded="true">Pending</a></li>
                          <li role="presentation" class=""><a href="{{  url('Admin/approved_orders') }}" aria-expanded="false">Approved</a>
                          </li>
                      ...
                      @foreach($shipments as $shipment)
                        <tr>
                          ...
                          if($status=='Approved' || $status=='In Transit' || $status=='Loaded'){
                            ...
                            ?>
                             <a class="btn btn-danger btn-sm waves-effect waves-light remove-record" onclick="return confirmDelete('{{ $shipment->id }}')" data-toggle="modal" data-url="{!! URL::to('Admin/all_orders/delete', $shipment->id) !!}" data-id="{{$shipment->id}}" data-target="#confirmDelete"><i class="fa fa-trash"></i>&nbsp;Delete</a>
                            <?php
                          }
                            ?>
...
<form action="{{ URL::to('Admin/all_orders/delete/') }}" method="POST" class="remove-record-model">
{{csrf_field()}}
{{method_field('delete')}}
