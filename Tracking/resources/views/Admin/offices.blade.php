                  ...
                  <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                      ...
                      @foreach($offices as $office)
                        ...
                        <td>{{ $office->id }}</td>
                          ...
                          <td><button data-toggle="modal" href="#modalDefault" onclick="return editUser('{{ $office->id }}','{{ $office->name }}','{{ $office->city }}','{{ $office->location }}','{{ $office->address }}','{{ $office->contact }}','{{ $office->contact_person }}')" class="btn btn-success btn-sm "><i class="fa fa-edit"></i> edit </button> 
                          <a class="btn btn-danger btn-sm waves-effect waves-light remove-record" onclick="return confirmDelete('{{ $office->id }}')" data-toggle="modal" data-url="{!! URL::to('Admin/offices/delete', $office->id) !!}" data-id="{{$office->id}}" data-target="#confirmDelete"><i class="fa fa-trash"></i>&nbsp;Delete</a>
                          </td>
                        </tr>
                         @endforeach
                      </tbody>
