                    ...
                    <div class="col-md-12">
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                          ...
                          <li role="presentation" class="active"><a href="{{  url('Admin/delivered_orders') }}"  aria-expanded="false">Delivered</a>
                          </li>
...
<form action="{{ URL::to('Admin/delivered_orders/delete/') }}" method="POST" class="remove-record-model">
{{csrf_field()}}
{{method_field('delete')}}
