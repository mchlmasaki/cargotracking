                    ...
                    <div class="col-md-12">
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                          ...
                          <li role="presentation" class=""><a href="{{  url('Admin/pending_orders') }}"  aria-expanded="true">Pending</a>
                          </li>
                          ...
                          <li role="presentation" class="active"><a href="{{  url('Admin/cancelled_orders') }}"  aria-expanded="false">Cancelled</a>
                          </li>
                        </ul>
                      </div>
...
<form action="{{ URL::to('Admin/cancelled_orders/delete/') }}" method="POST" class="remove-record-model">
{{csrf_field()}}
{{method_field('delete')}}
