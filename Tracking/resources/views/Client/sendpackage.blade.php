...
@include('flash::message')
        ...
        <!-- page content -->
            ...
            <div class="row">
              ...
              <h4 class="modal-title" style="color: black;">Send Parcel/Documents/Goods</h4>
              </div>
              
              <h2 style="color: black;">Shipper/Sender Information</h2>
              ...
              <?php 
                     ...
                     <h2 style="color: black;"><br><br><br><br>Nearest City/Town</h2>
                      ...
                      @endforeach
                       ...
                       <h2 style="color: black;"><br><br><br><br>Receiver's Information</h2>
                       <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback {{ $errors->has('receiver_name') ? ' has-error' : '' }} ">
                      ...
                      <h2 style="color: black;"><br><br><br><br>Shipment Information</h2>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback {{ $errors->has('description') ? ' has-error' : '' }} ">
                        <textarea type="text" class="form-control"  name="description" value="{{ old('description') }}" id="description" placeholder="Shipment Description" rows="5"></textarea>
