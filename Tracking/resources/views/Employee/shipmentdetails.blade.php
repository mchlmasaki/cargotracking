            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="row no-print">
                        <div class="col-xs-12">
                          <button class="btn btn-default" action="action" onclick="window.history.go(-1); return false;" type="button"><i class="glyphicon glyphicon-arrow-left"></i>Go backs</button>
