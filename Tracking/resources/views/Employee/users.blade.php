                      ...
                      @foreach($users as $user)
                        ...
                        <td>{{ $user->id }}</td>
                          ...
                          <td>
                            ...
                            ?></td>
                          <td><button data-toggle="modal" href="#updateModal" onclick="return editUser('{{ $user->id }}','{{ $user->name }}','{{ $user->email }}','{{ $user->contact }}')" class="btn btn-success btn-sm "><i class="fa fa-edit"></i> Update </button> 
